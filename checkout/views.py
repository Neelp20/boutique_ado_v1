...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        if order_form.is_valid():  # if form is valid
            order = order_form.save()  # will save the order
            for item_id, item_data in bag.items():  # and then we need to iterate through the bag items to create each line item
                try:
